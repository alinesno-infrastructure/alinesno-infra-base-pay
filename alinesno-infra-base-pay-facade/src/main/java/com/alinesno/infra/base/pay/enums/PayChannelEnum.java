package com.alinesno.infra.base.pay.enums;
...
public enum PayChannelEnum {
    ...
    PayChannelEnum(String name, String desc, String icon) {
        this.name = name;
        this.desc = desc;
        this.icon = icon;
    }

    public static List<PayChannelEnum> getAllDocumentTypes() {
        return Arrays.asList(PayChannelEnum.values());
    }

    public static Object[] getAllNames() {
        PayChannelEnum[] documentTypes = PayChannelEnum.values();
    ...
    public static String getAllNameStr() {
        ...
        for(PayChannelEnum d : getAllDocumentTypes()){
            names.append(",")
                 .append(d.getName());
        }
