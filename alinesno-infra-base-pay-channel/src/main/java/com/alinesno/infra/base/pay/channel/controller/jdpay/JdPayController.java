package com.alinesno.infra.base.pay.channel.controller.jdpay;

import cn.hutool.core.codec.Base64;
import cn.hutool.core.date.DateUtil;
import cn.hutool.core.io.FileUtil;
import cn.hutool.core.util.XmlUtil;
import com.alinesno.infra.base.pay.channel.properties.JdPayBean;
...
public class JdPayController {
	...
	@ResponseBody
	public String index() {
		log.info("欢迎使用 IJPay 中的京东支付 -By Javen  <br/><br>  交流群：");
		log.info(jdPayBean.toString());
		return ("欢迎使用 IJPay 中的京东支付 -By Javen  <br/><br>  交流群：");
	}
	...
	public AjaxResult appPay() {
		...
		return AjaxResult.success(new AppParams(orderId, jdPayBean.getMchId(), "123456789",
			sign, "123456789"));
	}
