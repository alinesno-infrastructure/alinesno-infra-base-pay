 ...
 * @author Javen
 */
package com.alinesno.infra.base.pay.channel.controller.paypal;
...
import com.alinesno.infra.base.pay.channel.properties.PayPalBean;
...
public class PayPalController {
	...
	@ResponseBody
	public String index() {
		log.info("欢迎使用 IJPay 中的 PayPal 支付 -By Javen  <br/><br>  交流群：");
		log.info(payPalBean.toString());
		return ("欢迎使用 IJPay 中的 PayPal 支付 -By Javen  <br/><br>  交流群：");
	}
