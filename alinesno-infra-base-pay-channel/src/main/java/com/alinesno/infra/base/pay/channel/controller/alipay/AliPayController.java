package com.alinesno.infra.base.pay.channel.controller.alipay;

import com.alibaba.fastjson.JSONObject;
import com.alinesno.infra.base.pay.channel.properties.AliPayBean;
import com.alinesno.infra.base.pay.channel.utils.PayStringUtils;
...
//    private final static String RETURN_URL = "/aliPay/return_url";
	...
	@ResponseBody
	public String index() {
		return "欢迎使用 IJPay 中的支付宝支付 -By Javen  <br/><br>  交流群：";
	}
	...
	public void wapPay(HttpServletResponse response) {
		...
		String outTradeNo = PayStringUtils.getOutTradeNo();
...
//        String notifyUrl = aliPayBean.getDomain() + NOTIFY_URL;
	...
	public String transfer() {
		...
		model.setOutBizNo(PayStringUtils.getOutTradeNo());
	...
	public String transferQuery(@RequestParam(required = false, name = "outBizNo") String outBizNo,
		...
		if (PayStringUtils.isNotEmpty(outBizNo)) {
			model.setOutBizNo(outBizNo);
		}
		if (PayStringUtils.isNotEmpty(orderId)) {
	...
	public AlipayFundAuthOrderFreezeResponse authOrderFreeze(@RequestParam("auth_code") String authCode) {
		try {
			...
			model.setOutOrderNo(PayStringUtils.getOutTradeNo());
			model.setOutRequestNo(PayStringUtils.getOutTradeNo());
			model.setAuthCode(authCode);
	...
	public String tradeRefund(@RequestParam(required = false, name = "outTradeNo") String outTradeNo, @RequestParam(required = false, name = "tradeNo") String tradeNo) {
		...
		try {
			...
			if (PayStringUtils.isNotEmpty(outTradeNo)) {
				model.setOutTradeNo(outTradeNo);
			}
			if (PayStringUtils.isNotEmpty(tradeNo)) {
